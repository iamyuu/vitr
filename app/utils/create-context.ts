...
type CreateContextReturn<TValue> = [
	() => TValue,
	React.Provider<TValue>,
	React.Context<TValue>,
];
 ...
 * ```
 */
export function createContext<TContextValue>(
	...
	return [
		...
		Context.Provider,
		Context,
	] as CreateContextReturn<TContextValue>;
}
